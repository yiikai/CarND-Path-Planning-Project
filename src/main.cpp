      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
			...
			{
				//useing previous two couple point to calc the ref point and point yaw(heading) 
			...
			//shift car reference angle to 0 degree. This is a trick for simple math calc
			//like MPC what we had done
			...
			//define teh actual (x,y) values what we will use in path planner
